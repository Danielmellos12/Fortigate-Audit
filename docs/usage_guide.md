...
|--------|-------------|----------|
| HTML | Executive-style interactive report with KPI summary, filters, category scores, and control drilldowns | Browser viewing, presentations |
